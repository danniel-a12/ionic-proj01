...
let ContactsPage = class ContactsPage {
    ...
    contactSend() {
        ...
        this.afs.collection('contacts').add(this.contactForm.value)
            .then(() => {
            // Exibe o feedback
            this.app.myAlert('Contato Enviado', 'Se contato foi enviado com sucesso!<br><br>Obrigado...', () => {
